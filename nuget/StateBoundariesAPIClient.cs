...
namespace APIVerve.API.StateBoundaries
{
    ...
    /// <summary>
    /// Client for the StateBoundaries API
    /// </summary>
    public class StateBoundariesAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/stateboundaries";
        ...
        {
            { "state", new ValidationRule { Type = "string", Required = true, MinLength = 2, MaxLength = 2 } }
        };
        ...
        public StateBoundariesAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public StateBoundariesAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public StateBoundariesAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, StateBoundariesQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(StateBoundariesQueryOptions options)
        {
        ...
        public ResponseObj Execute(StateBoundariesQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(StateBoundariesQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(StateBoundariesQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(StateBoundariesQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(StateBoundariesQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(StateBoundariesQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(StateBoundariesQueryOptions options)
        {
