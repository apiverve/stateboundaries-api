...
class stateboundariesWrapper {
    ...
    constructor(options) {
        ...
        this.validationRules = {"state":{"type":"string","required":true,"minLength":2,"maxLength":2}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/stateboundaries`);
        }
    }
