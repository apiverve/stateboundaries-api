...
const (
	baseURL        = "https://api.apiverve.com/v1/stateboundaries"
	defaultTimeout = 30 * time.Second
)

// Client is the State Boundaries API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new State Boundaries API client.
...
// Execute makes a request to the State Boundaries API with typed parameters.
//
